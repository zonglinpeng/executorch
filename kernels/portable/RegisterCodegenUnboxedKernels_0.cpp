...
static Kernel kernels_to_register[] = {
    ...
    Kernel(
    	...
    	bool non_blocking_base = non_blocking.to<bool>();
            ...
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_copy_");
    ...
    Kernel(
    	...
    	bool non_blocking_base = non_blocking.to<bool>();
    	    ...
    	    torch::executor::optional<torch::executor::ArrayRef<int64_t>> dim_order_opt_out = dim_order.toOptional<torch::executor::ArrayRef<int64_t>>();
    	            
    	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
    
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call__to_dim_order_copy.out");
